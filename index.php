                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                            		...
                            		<p>Por favor, ingrese su usuario y contraseña para acceder:</p>
                        		</div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-sm-offset-3 social-login">
                              <h3>Sí requieres de mayor información o estas interesado en nuestro sistema:</h3>
                              <div class="social-login-buttons">
                                <a class="btn btn-link-2" href="contactanos_login.php">
                                  <i class="glyphicon glyphicon-inbox"></i>   Contáctanos
                                </a>
                              </div>
                            </div>
                        </div>
